...
def add_new_holiday_with_supplies(holiday_hash, season, holiday_name, supply_array)
  # holiday_hash[:season][:holiday_name] = supply_array / your first attempt, you don't need the colons 
  ...
  # include the string "BBQ"
    holiday_hash.map do |season, data|
      data.map do |holiday, supplies|
        ...
        #  "#{holiday}" first attempt you dont need to interpolate, you can just do this: 
        holiday
        end
      end 
    end.flatten.compact    
